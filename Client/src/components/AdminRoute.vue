<template>
  ...
  <div
    ...
    style="padding-top: 100px; margin-top: 10px"
  >
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-4" @click="openAddLocationModal">
          <div
            class="image-container position-relative text-center add-location-card"
          >
      ...
      <div
        ...
        role="dialog"
        :class="{
          modalStyleZindex: modalStyle,
          modalStyleZindex2: !modalStyle,
        }"
      >
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <!-- :class="{modalStyleZindex : modalStyle}" -->
              ...
              <form @submit.prevent="addLocation">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="location-name"
                    v-model="newLocationEnglishName"
                    required
                  />
                </div>
                <br />
...
export default {
  ...
  methods: {
    ...
    fetchimage() {
      axios
        .get("http://192.168.0.78:3000/api/toursiteimage")
        .then((response) => {
    ...
    deleteImage(data_id) {
      if (confirm("이미지를 삭제하시겠습니까?")) {
        axios
          .put(`http://192.168.0.78:3000/api/toursiteimage/modify/${data_id}`)
          .then(() => {
            const index = this.toursiteimage.findIndex(
    ...
    addLocation() {
      ...
      axios
        .post("http://192.168.0.78:3000/api/toursiteimage/add", formData, {
          headers: {
